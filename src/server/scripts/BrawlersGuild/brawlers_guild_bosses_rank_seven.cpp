...
{
    // nibleah
    SPELL_ACID_SPIT             = 140914,
    SPELL_ACIT_AT               = 141013,

    // epicus
    SPELL_INTRO_INVIS           = 69676,
    SPELL_INTRO_SCALE           = 142758,
    // shark
    SPELL_BLUE_CRUSH            = 133262,
    SPELL_OUTRO_DIED            = 133259,
    // gun
    SPELL_SUMMON_TARGET         = 133222,
    SPELL_DESTRUCTION_LASER     = 133233,
    SPELL_LASER_DMG             = 133230,
    // guitar
    SPELL_ROCK_N_ROLL           = 133205,
